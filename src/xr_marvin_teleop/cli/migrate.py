...
from xr_marvin_teleop.collection.config import load_config, write_json
from xr_marvin_teleop.collection.episode_package import extract_episode_mcap, read_attachment
...
def verify(path):
    ...
    from xr_marvin_teleop.collection.episode_video import h264_nal_types
