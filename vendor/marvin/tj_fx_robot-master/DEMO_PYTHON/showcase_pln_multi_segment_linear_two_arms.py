...
'''
ini_result1 = kk1.load_config(arm_type=0, config_path=os.path.join(parent_dir,'CommonConfig/config/ccs_680.MvKDCfg'))
ini_result2 = kk2.load_config(arm_type=1, config_path=os.path.join(parent_dir,'CommonConfig/config/ccs_680.MvKDCfg'))
...
points_arm0 = [
            ...
            [509.731, 73.614, 205.949, -169.144, 55.011, -146.752],
            [509.731, 73.614, 265.949, -169.144, 55.011, -146.752]
        ]
